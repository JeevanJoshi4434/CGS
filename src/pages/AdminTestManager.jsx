...
import { FiPlus, FiLink, FiTrash2, FiEdit, FiX } from 'react-icons/fi';
...
const AdminTestManager = () => {
    ...
    const handleCreateTest = () => {
        if (newTest.name && newTest.location) {
            const testId = Date.now();
            const testLink = `test/${testId}`;
                        ...
                        <div className="flex justify-between items-center mb-6">
                            ...
                            <div className="md:hidden flex gap-2">
                                ...
                                <button
                                    ...
                                    className={`px-3 py-1 text-sm rounded-md ${activeTab === 'archived' ? 'bg-blue-100 text-blue-700' : 'bg-gray-100'}`}
                                >
                                    Archived
                                </button>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="pt-4 flex justify-end gap-3">
                                    ...
                                    <button
                                        ...
                                        disabled={!newTest.name || !newTest.location}
                                        className={`px-4 py-2 rounded-md text-white ${!newTest.name || !newTest.location ? 'bg-blue-400 cursor-not-allowed' : 'bg-blue-600 hover:bg-blue-700'}`}
                                    >
                                        Create Test
                                    </button>
                                </div>
