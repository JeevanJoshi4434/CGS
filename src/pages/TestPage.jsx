...
const TestPage = () => {
    ...
    const handleOptionSelect = (questionId, option) => {
        setSelectedOptions(prev => {
            ...
            if (question?.multiple) {
                ...
                return {
                    ...prev,
                    [questionId]: currentSelections.includes(option)
    ...
    const calculateScore = () => {
        ...
        allQuestions.forEach(question => {
            if (question.answer && selectedOptions[question.id] === question.answer) {
                correctAnswers++;
            }
        });
                ...
                <div className="p-4 sm:p-6">
                    ...
                    {showScore ? (
                        <div className="text-center py-10">
                            ...
                            <p className="mb-4 text-gray-600">Your Score: {score} / {allQuestions.length}</p>
                            <button
                                onClick={resetTest}
